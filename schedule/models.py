...
class Task(models.TextChoices):
    ...
    auto_reload_supervisor = 'schedule.tasks.auto_reload_supervisor', '自动更新并重载'
    auto_push_complete_torrents_to_server = 'schedule.tasks.auto_push_complete_torrents_to_server', '推送辅种数据'
