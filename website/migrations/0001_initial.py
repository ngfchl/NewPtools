        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "sp_full",
                    models.FloatField(
                        default=107, help_text="站点满时魔", verbose_name="满魔"
                    ),
                ),
                (
                    "limit_speed",
                    models.IntegerField(
                        default=100, help_text="单种限速，单位：MB/S", verbose_name="上传速度限制"
                    ),
                ),
                (
                    "func_sign_in",
                ...
                (
                    "func_get_torrents",
                    models.BooleanField(default=True, verbose_name="拉取种子"),
                ),
                (
                    "func_get_userinfo",
                    models.BooleanField(default=True, verbose_name="站点数据"),
                ),
                (
                    "func_hr_discern",
                    models.BooleanField(default=False, verbose_name="HR识别"),
                ),
                (
                    "func_repeat_torrents",
                    models.BooleanField(default=False, verbose_name="辅种支持"),
                ),
                (
                    "func_brush_flow",
                    models.BooleanField(default=False, verbose_name="刷流支持"),
                ),
                (
                ...
                (
                    "page_index",
                    models.CharField(
                        default="index.php", max_length=64, verbose_name="首页"
                    ),
                ),
                (
                    "page_torrents",
                    models.CharField(
                        default="torrents.php?incldead=1",
                        max_length=64,
                        verbose_name="默认搜索页面",
                    ),
                ),
                ...
                (
                    "page_search",
                    models.CharField(
                        default="torrents.php?incldead=1&search={}",
                        max_length=64,
                        verbose_name="搜索链接",
                    ),
                ),
                (
                    "page_message",
                    models.CharField(
                        default="messages.php", max_length=64, verbose_name="消息页面"
                    ),
                ),
                (
                    "page_hr",
                    models.CharField(
                        default="myhr.php?hrtype=1&userid={}",
                        max_length=64,
                        verbose_name="HR考核页面",
                    ),
                ),
                ...
                (
                    "search_params",
                    models.JSONField(
                        default=website.models.get_search_params,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "days",
                    models.IntegerField(
                        default=0, help_text="原样输入，单位：周", verbose_name="时 间"
                    ),
                ),
                (
                    "uploaded",
                ...
                (
                    "torrents",
                    models.IntegerField(
                        default=0, help_text="发布种子数", verbose_name="发 种"
                    ),
                ),
                (
                    "leeches",
                    models.IntegerField(
                        default=0, help_text="完成种子数", verbose_name="吸血数"
                    ),
                ),
                (
                    "seeding_delta",
                    models.FloatField(
                        default=0, help_text="累计做种时间", verbose_name="做种时间"
                    ),
                ),
                (
                    "rights",
                    models.TextField(
                        help_text="当前等级所享有的权利与义务", max_length=256, verbose_name="权 利"
                    ),
                ),
                (
                    "site",
